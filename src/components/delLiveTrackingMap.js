...
import { delLogged, finalLocations } from "../components/actions";
...
function LiveTrackingMaps() {
  ...
  function getDelLocation() {
    ...
    axios
      .post(`http://localhost:5000/api/location/${latitude}/${longitude}`, formData, config)
      .then((res) => { })
      .catch((err) => console.log(err));
